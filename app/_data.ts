...
export const projects: Project[] = [
  ...
  },
  {
    ...
    descPlain: "When an automated test breaks, most tools just say it failed. This one looks at what actually went wrong, explains it in plain terms, and suggests a fix — a human reviews it before anything changes. 32 tests passing, verified against a real AI service.",
...
// Transaction-flow visualizer (PLAN §3B) — plain-English stations only, zero
// jargon (no EMV/ISO-8583/acquirer/issuer), per §1's client-dialect rule.
export const paymentFlowStations = [
  { label: "Card", desc: "You tap or insert it." },
  { label: "Reader", desc: "The shop's machine sends the request out." },
  { label: "Network", desc: "Routes it to the right bank, instantly." },
  { label: "Bank", desc: "Checks the account. Says yes or no." },
];
